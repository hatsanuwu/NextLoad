...
<header class="bg-light p-5 mb-4 text-center">
  <div class="container">
    <h1 class="display-5 fw-bold text-success">Bienvenido a NextLoad</h1>
    <p class="lead text-muted">Descubre historias, análisis y novedades del mundo de la tecnología.</p>
    <a href="#noticias" class="btn btn-success btn-lg">Explorar publicaciones</a>
  </div>
</header>
